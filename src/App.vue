    ...
    <template v-if="loggedIn">
      ...
      <v-toolbar app>
        ...
        <v-btn light flat  href="" target="_blank">
            ...
            <span style="margin-left:0.4rem;">Viewer</span>
          </v-btn>
      </v-toolbar>
      <v-content>
        <v-container fluid >
      ...
      <v-footer :inset="true" style="justify-content:center; text-align: center" app>
        <span>&copy; mangesh trimbake @ 2020</span>
      </v-footer>
    </template>
  </v-app>
    ...
    data () {
      return {
        ...
        items: [
          ...
          //   link: "entrepreneurships"
          // },
          {
            icon: "bubble_chart",
            title: "PathologyImages",
            vertical: "PathologyImages",
            link: "pathology-images"
          },
          // {
          //   icon: "thumbs_up_down",
          //   title: "About",
